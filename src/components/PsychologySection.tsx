...
export function PsychologySection() {
  return (
    <SectionShell
      id="psychology"
      eyebrow="07 / психология юмора"
      title="Психологические теории юмора и их иллюстрации"
      lead="Пять психологических линий показывают, как шутка работает с напряжением, защитой, отношениями в группе и внутренними противоречиями человека."
    >
