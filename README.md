...
- Hero/OG-изображение `public/assets/hero-from-engraving-to-meme.jpg` сгенерировано для проекта в концепции «от гравюры к мему».
...
- Дополнительные иллюстрации галереи `theater-portal-illustration.jpg`, `satirical-print-workshop.jpg`, `digital-meme-archive.jpg` сгенерированы для проекта и используются как визуальные метафоры эпох.
